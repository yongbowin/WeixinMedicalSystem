package com.clouds.igankong.weixin;
/**
 * 核心Service类
 * 
 * */
...
import com.clouds.igankong.weixinUtils.MsgRespTextMessage;
import com.clouds.igankong.weixinUtils.MsgUtil;
public class CoreService {
	...
	public static String processRequest(String request) {
		...
		try {
			...
			// 回复文本消息
			MsgRespTextMessage textMessage = new MsgRespTextMessage();
			...
			// 事件推送
				...
				// 上报地理位置
				else if (eventType.equals(MsgUtil.REQ_MESSAGE_TYPE_LOCATION)) {
					// TODO 处理上报地理位置事件
				}
				// 自定义菜单
...
//					 事件KEY值，与创建自定义菜单时指定的KEY值对应  
			...
			// 将文本消息对象转换成xml
			respXml = MsgUtil.textMessageToXml(textMessage);
		} catch (Exception e) {
			e.printStackTrace();
		}
		return respXml;
