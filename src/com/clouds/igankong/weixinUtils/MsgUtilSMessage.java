...
public class MsgUtilSMessage {
   ...
   public static void main(String[] args) {
	   ...
	   // 新建图文
	   MsgRespArticle article1 = new MsgRespArticle();
	   ...
	   MsgRespArticle article2 = new MsgRespArticle();
	   ...
	   // 整合图文
	   List<MsgRespArticle> list = new ArrayList<MsgRespArticle>();
	   list.add(article1);
	   list.add(article2);
	   // 图文转json
