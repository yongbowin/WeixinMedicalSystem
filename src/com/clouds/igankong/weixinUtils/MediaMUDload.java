...
public class MediaMUDload {
     ...
     * 普通文件（file）：10MB
	 * */
	public static MediaWeixin uploadMedia(String accessToken, String type, String mediaFileUrl) {
		MediaWeixin weixinMedia = null;
		// 拼装请求地址
	...
	public static void main(String[] args) {
		...
		//地址
		MediaWeixin weixinMedia = uploadMedia(access_token, "image", "http://localhost:8080/weixinClient/weather1.jpg");
		//media_id
