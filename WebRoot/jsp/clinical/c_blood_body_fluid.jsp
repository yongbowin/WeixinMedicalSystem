			   ...
			   <div class="panel">
				    ...
				    <div id="collapseOne" class="panel-collapse collapse in">
				      <div class="panel-body" style="border: 1px solid #5EC02D;">
				        <!-- 基本信息-页面 -->
				        <%@ include file="c_blood_body_fluid/base_info.jsp" %>
				      </div>
				    </div>
				  </div>
			</form>
			   ...
			   <div class="panel" style="margin-top: 6px;">
			      ...
			      <div id="collapseTwo" class="panel-collapse collapse">
			         <div class="panel-body" style="border: 1px solid #F59B79;">
			            <!-- 本底信息-页面 -->
				        <%@ include file="c_blood_body_fluid/self_base_info.jsp" %>
			         </div>
			      </div>
			   </div>
		   </form>
			   ...
			   <div class="panel" style="margin-top: 6px;">
			      ...
			      <div id="collapseThree" class="panel-collapse collapse">
			         <div class="panel-body" style="border: 1px solid #F19D9B;">
			            <!-- 暴露源情况-页面 -->
				        <%@ include file="c_blood_body_fluid/expose_source_info.jsp" %>
			         </div>
			      </div>
			   </div>
		   </form>
			   ...
			   <div class="panel" style="margin-top: 6px;">
			      ...
			      <div id="collapseFour" class="panel-collapse collapse">
			         <div class="panel-body" style="border: 1px solid #80CEF5;">
			            <!-- 体液血液暴露事件描述-页面 -->
				        <%@ include file="c_blood_body_fluid/blood-fluid-event-info.jsp" %>
			         </div>
...
<!-- 条目右侧三角形动态效果 -->
<script src="${pageContext.request.contextPath }/js/clinical/c_blood_body_fluid.js"></script>
