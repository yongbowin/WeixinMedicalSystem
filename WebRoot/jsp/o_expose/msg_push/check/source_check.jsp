...
<div class="s-sc-expose-happen-word">点击选择未知暴露源所对应的暴露事件</div>

<div class="container">

	<form class="form-horizontal" role="form">
	
		<div class="s-sc-select-expose-event">
			<div class="s-sc-select-expose-event-1">2016.12.31</div>
			<div class="s-sc-select-expose-event-2">血液体液暴露</div>
			<div class="s-sc-select-expose-event-3">
				<div class="s-sc-select-expose-event-3-sub"></div>
			</div>
		</div>
	
		<div class="s-sc-select-sharp-event">
			<div class="s-sc-select-sharp-event-1">2016.12.31</div>
			<div class="s-sc-select-sharp-event-2">锐器伤暴露</div>
			<div class="s-sc-select-sharp-event-3">
				<div class="s-sc-select-sharp-event-3-sub"></div>
			</div>
		</div>
		
		<!-- 实线 -->
		<div class="s-check-revi-line" style="margin: 8px auto;"></div>
		
		<div class="form-group" style="padding-bottom: 0;">
	    	<div class="c-con-sen-name">
	    		<input class="form-control bor-color-2" placeholder="患者姓名（建议输入）" >
	    	</div>
		...
		<div class="form-group">
	    	<span class="control-label s-check-revi_title">检查结果</span>
...
<script src="${pageContext.request.contextPath }/js/sense_control/msg_push/source_check.js"></script>
